 ...
 * @author PICHAU
 */
public class InfoHardware extends javax.swing.JFrame {

    /**
     * Creates new form InfoHardware
     */
    public InfoHardware() {
        initComponents();
        this.setUpOs();
    ...
    private void setUpOs() {
        ...
        txtSistema.setText(looca.getSistema().toString());
        TxtProcessador.setText(looca.getProcessador().toString());
        txtMemoria.setText(looca.getMemoria().toString());
        txtDisco.setText(looca.getGrupoDeDiscos().getDiscos().toString());
    }
    ...
    private void initComponents() {
        ...
        txtDisco = new javax.swing.JTextArea();
        ...
        jLabel1.setText("INFORMAÇÕES DA SUA MÁQUINA");
        ...
        txtDisco.setColumns(20);
        txtDisco.setRows(5);
        jScrollPane3.setViewportView(txtDisco);

        txtMemoria.setColumns(20);
        txtMemoria.setRows(5);
        jScrollPane4.setViewportView(txtMemoria);
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1050, 510));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoHardware.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InfoHardware().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea txtDisco;
